...
clc;
%   Problem parameters
T_c = 220;     % Temperature in the combustion chamber (K)
P_c = 30e5;    % Pressure in the combustion chamber (Pa)
P_amb = 101e3;  % Ambient pressure (Pa)
T_amb = 295;    % Ambient temperature (K)
gamma = 1.3;   % Ratio of Specific Heats Cp/Cv (Gamma)
W = 48;       % Molecular weight of gas (kg/kmol)
width = .19;     % Nozzle width (meters)
h_th = .01;    % Throat  height (meters)
